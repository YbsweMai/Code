...
7. 
   ...
   - 如果不是质数，将其分解质因数 如：24 = 2 * 2 * 2 * 3，将分解出的质数打印出来。
     ...
     function isPrime(n){
         ...
         return true;
     }// https://blog.csdn.net/zhuoyunpeng/article/details/99685478?utm_medium=distribute.pc_relevant.none-task-blog-OPENSEARCH-8.channel_param&depth_1-utm_source=distribute.pc_relevant.none-task-blog-OPENSEARCH-8.channel_param
