<template>
    <div class="container">
        ...
        <div class="content">
            <div class="slide">
                <h3 class="nav" @click="jumpCode('code')">编程入门</h3>
                <h3 class="nav" @click="jumpCode('lesson')">自主学习</h3>
                <h3 class="nav" @click="jumpCode('interest')">趣味小课</h3>
            </div>
            <div class="main">
                <div class="item-box">
                    <div v-for="(item, index) in list" :key="index">
                        <div v-if="nowClick === item.type" class="item" >
                            <div class="box-top">
                    ...
                    <!-- <div v-for="(item,index) in list" :key="'l'+index" class="item">
                        <template v-if="nowClick === item.type">
                            <div class="box-top">
                                <img :src="item.coverUrl" alt="">  
                                <h1 class="box-title">{{item.title}}</h1>
                            </div>
    ...
    methods: {
        jumpCode(name){
            ...
            this.list.forEach(obj => {
                if(obj.type==this.nowClick){
                    console.log('11', obj.type)
                }
            });
        }
    },
